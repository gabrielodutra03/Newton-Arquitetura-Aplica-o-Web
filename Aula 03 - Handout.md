...
> **Nomes:** ___Gabriel Otone e Cauã Papa_________________   **Turma:** ____________________   **Data:** _20__ / _08__ / _2026_____
...
1. Qual(is) problema(s) de design vocês identificam? O problema é o verbo Get utilizado, o metodo POST e o response muito grande

2. Seu redesenho (método + rota + status codes): GET/api/Alunos
...
1. Qual(is) problema(s) de design vocês identificam? O problema é o Get que deveria ser Delete e o retorno está incorreto
...
1. Qual(is) problema(s) de design vocês identificam? Anti padrao de alinhamento

2. Seu redesenho (método + rota + status codes): GET/escolas/disciplinas/12
...
1. Qual(is) problema(s) de design vocês identificam? O retorno está incorreto
